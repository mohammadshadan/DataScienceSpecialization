#MOHAMMAD SHADAN
#Objevtive : Re-create plot for Global Active Power variation over two days and save as PNG File (480x480)
...
#For plot2
#plot for Global Active Power variation over two days
